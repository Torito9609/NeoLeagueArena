...
public class PanelPerfilEntrenador extends JPanel {
    ...
    public PanelPerfilEntrenador(String nombre, String id, ImageIcon foto) {
        ...
        lblFotoPerfil = new JLabel(); // Inicialización del atributo
        ...
        lblRol = new JLabel("ENTRENADOR"); // Inicialización del atributo
        ...
        lblNombreEntrenador = new JLabel(nombre); // Inicialización del atributo
        lblNombreEntrenador.setFont(new Font("Arial", Font.BOLD, 18));
        panelInfoTexto.add(lblNombreEntrenador);

        lblIdEntrenador = new JLabel(id); // Inicialización del atributo
	...
	public void setLblNombreEntrenador(JLabel lblNombreEntrenador) {
		this.lblNombreEntrenador = lblNombreEntrenador;
	}

	public void setLblIdEntrenador(JLabel lblIdEntrenador) {
		this.lblIdEntrenador = lblIdEntrenador;
	}
