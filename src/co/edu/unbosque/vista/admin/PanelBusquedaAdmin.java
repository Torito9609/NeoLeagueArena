...
/**
 * PanelBusqueda representa un panel gráfico utilizado en la vista del
 * administrador para permitir la búsqueda y filtrado de usuarios por diferentes
 * criterios como nombre, cédula, correo, tipo de usuario, país y ciudad.
 *
 * Este panel es pasivo y está diseñado para ser controlado desde un controlador
 * externo, sin contener lógica de negocio.
 * 
...
public class PanelBusquedaAdmin extends JPanel {
	...
	/**
	 * Constructor que inicializa el panel con su disposición y componentes
	 * visuales.
	 */
