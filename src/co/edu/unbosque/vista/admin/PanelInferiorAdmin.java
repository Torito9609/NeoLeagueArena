...
/**
 * {@code PanelInferior} es un panel gráfico que contiene los botones
 * principales de acciones administrativas para la gestión de usuarios, como
 * crear, editar y eliminar. Todo realizado desde la tabla, están pensados para
 * interactuar con la tabla
 * 
 * Esta clase forma parte de la interfaz de usuario del módulo de administración
 * y es utilizada normalmente en la parte inferior de una ventana o sección
 * administrativa.
 * 
 * Cada botón tiene asociado un comando de acción que debe ser gestionado desde
 * el controlador.
 * 
 * <p>
 * Responsabilidades:
...
public class PanelInferiorAdmin extends JPanel {
	...
	/**
	 * Crea una instancia del panel inferior con disposición de botones alineada a
	 * la derecha y con fondo gris claro.
	 */
	...
	/**
	 * @return el botón para crear un usuario.
	 */
	...
	/**
	 * @param crearButton botón para crear un usuario.
	 */
